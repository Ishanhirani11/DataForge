"""
Database data loader for DataFlow Pro.
...
from dataflow_pro.config import get_app_config, DatabaseConfig
...
class DatabaseLoader:
    ...
    def __init__(
        ...
        self.config = config or get_app_config().database
    ...
    def _batch_insert(
        ...
        with self.get_connection() as conn:
            stmt = insert(self.table_name).values(data)
    ...
    def _batch_upsert(
        ...
        with self.get_connection() as conn:
            ...
            # Get primary key columns (assuming 'id' for simplicity)
            primary_columns = ["id"]
            ...
            result = conn.execute(on_conflict, data)
