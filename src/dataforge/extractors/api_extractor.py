"""
API data extractor for DataForge.
...
from dataforge.utils.retry_handler import RetryConfig, BackoffStrategy, RetryHandler
...
class APIExtractor:
    ...
    def make_request(
        ...
        request_params = {**self.request_config.params, **(params or {})}
    ...
    def extract_all(
        ...
        while True:
            ...
            if self.pagination_config.type == PaginationType.OFFSET:
                ...
                if page > 1 and last_result and last_result.next_cursor:
                    request_params[self.pagination_config.cursor_param] = last_result.next_cursor
