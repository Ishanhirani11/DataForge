"""
Metrics collection and monitoring for DataForge.
...
class MetricsCollector:
    ...
    def __init__(self, service_name: str = "dataforge"):
...
def get_metrics(service_name: str = "dataforge") -> PrometheusMetrics:
    """
